...
export function HeroSection() {
  ...
  return (
    <div
      ...
      className="relative flex items-center justify-center h-[40vh] min-h-[300px] bg-gradient-to-br from-purple-700 via-indigo-700 to-blue-700 text-white overflow-hidden transition-opacity duration-300 ease-out container mx-auto rounded-lg"
    >
      ...
      <div className="relative z-10 text-center px-4 max-w-3xl rounded-3xl p-8 bg-white/10 backdrop-blur-sm shadow-2xl">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          <button onClick={() => handleScrollToSection("dashboard-section")} className="px-6 py-3 bg-white text-purple-700 rounded-full text-lg font-semibold hover:bg-gray-100 transition-colors shadow-lg">
            Explore the Dashboard
          </button>
          <button onClick={() => handleScrollToSection("top-search-section")} className="px-6 py-3 border border-white text-white rounded-full text-lg font-semibold hover:bg-white hover:text-purple-700 transition-colors shadow-lg">
